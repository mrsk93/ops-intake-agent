...
M1 created the identity tables. M2 adds the tenant-scoped artifact lifecycle table; SOP, draft, review and audit migrations remain deferred to later milestones.
